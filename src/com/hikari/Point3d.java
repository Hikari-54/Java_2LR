...
public class Point3d extends Point2d{
    ...
    public Point3d (double xCoord, double yCoord, double zCoord){
        ...
        super(xCoord, yCoord);
        // <this.> указывает на то, что используется поле ЭТОГО КЛАССА
        // а то что стоит справа - совершенно другой по значению входной аргумент
        this.zCoord = zCoord;
    }
    ...
    /* Этот нестатический метод сравнивает попарно координаты х, у, z двух объектов Point3d и возвращает результат сравнения */
